...
return new class extends Migration
{
    ...
    {
        // Для SQLite нужно пересоздать таблицу с новыми статусами
        if (DB::connection()->getDriverName() === 'sqlite') {
            ...
            // Копируем данные, сохраняя существующие статусы
    ...
    public function down(): void
    {
        ...
        if (DB::connection()->getDriverName() === 'sqlite') {
            ...
            // Копируем данные обратно, преобразуя новые статусы в старые
            DB::statement('INSERT INTO contracts_old SELECT 
                ...
                CASE 
                    ...
                    WHEN status = "in_production" THEN "approved"
                    WHEN status = "quality_check" THEN "approved"
