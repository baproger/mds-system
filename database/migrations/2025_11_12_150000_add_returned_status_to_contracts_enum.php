...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('CREATE TABLE contracts_tmp (
            ...
            "status" varchar check ("status" in ("draft", "pending_rop", "approved", "rejected", "on_hold", "in_production", "quality_check", "ready", "shipped", "completed", "returned")) not null default "draft",
        ...
        DB::statement('INSERT INTO contracts_tmp SELECT 
            ...
            order_due, photo_path, attachment_path, status, version, current_reviewer_id,
    ...
    public function down(): void
    {
        ...
        DB::statement('INSERT INTO contracts_tmp SELECT 
            ...
            CASE WHEN status = "returned" THEN "pending_rop" ELSE status END as status,
            version, current_reviewer_id, data, created_at, updated_at, manager, canvas_height
            FROM contracts');
