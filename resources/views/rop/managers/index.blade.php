...
.month-tag{background:#f3f4f6;color:var(--text-secondary);border-color:#d1d5db}
...
.modal-btn-cancel:hover{background:#e5e7eb;color:var(--text-secondary);transform:translateY(-1px);box-shadow:0 4px 8px rgba(0,0,0,.1)}
