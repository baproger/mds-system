...
.manager-item .personnel-icon{background:#f3e8ff;color:#0284c7}
...
.modal-btn-delete{background:linear-gradient(135deg,#ef4444 0%,#dc2626 100%);color:#1ba4e9;box-shadow:0 4px 12px rgba(239,68,68,.3)}
...
.settings-icon{width:48px;height:48px;border-radius:12px;background:linear-gradient(135deg,#3b82f6 0%,#2563eb 100%);color:#1ba4e9;display:flex;align-items:center;justify-content:center;font-size:20px;margin-bottom:16px}
